This project demonstrates the N-Queens problem, a classic backtracking algorithm where N queens must be placed on an N×N chessboard such that no two queens attack each other.
